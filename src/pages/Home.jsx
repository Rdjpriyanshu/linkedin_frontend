...
function Home() {
  ...
  return (
    <div className="w-full min-h-[100vh] bg-[#d9f1f7]">
      {/* EditProfile Modal - show only when edit is true */}
      {edit && <EditProfile />}
      ...
      <div className="max-w-7xl relative mx-auto pt-[100px] px-4 flex gap-6 justify-between">
        ...
        <div className="w-[300px] min-h-[300px] bg-white rounded-xl shadow-lg p-5 flex flex-col items-center gap-4">
          <div className="w-[100%] h-[150px] rounded overflow-hidden bg-gray-400 border-2 flex items-center justify-center">
            {/* Only render img if src exists, otherwise show placeholder */}
            {userData?.coverImage ? (
              <img
              ...
              <div className="text-gray-600 font-medium">Cover Photo</div>
            )}
          </div>
          ...
          <button
            ...
            className="w-full py-2 rounded-full border-2 border-[#f9c160] text-[#2dc0ff] font-semibold hover:bg-blue-50 transition justify-center items-center"
          >
