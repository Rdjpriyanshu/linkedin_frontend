    ...
    <div className="w-full h-screen bg-gradient-to-br from-blue-50 to-blue-100 flex flex-col items-center justify-start gap-6">
      ...
      >
        ...
        <div>
          ...
          />
          <span
            className="absolute cursor-pointer right-[534px] top-[443px] text-[#10c1f7] font-semibold"
      ...
      {error && <p className="text-center text-red-500">*{error}</p>}
        ...
        <button type="submit" className="w-full py-2 mt-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg shadow transition" disabled={loading}>
